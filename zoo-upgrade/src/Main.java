...
public class Main {
    ...
    public static void writeObjectsToFile(Tiger tiger, Penguin penguin, Dolphin dolphin) {
        // save tiger state
        try (FileOutputStream fileOutputStream = new FileOutputStream("tiger.txt");
        ...
        // save penguin state
        try (FileOutputStream fileOutputStream = new FileOutputStream("penguin.txt");
             ObjectOutputStream objectOutputStream = new ObjectOutputStream(fileOutputStream)) {
        ...
        // save dolphin state
        try (FileOutputStream fileOutputStream = new FileOutputStream("dolphin.txt");
             ObjectOutputStream objectOutputStream = new ObjectOutputStream(fileOutputStream)) {
    ...
    public static void readObjectsFromFile() {
        ...
        try (FileInputStream fileInputStream = new FileInputStream("tiger.txt");
        ...
        try (FileInputStream fileInputStream = new FileInputStream("penguin.txt");
             ObjectInputStream objectInputStream = new ObjectInputStream(fileInputStream)) {
        ...
        try (FileInputStream fileInputStream = new FileInputStream("dolphin.txt");
             ObjectInputStream objectInputStream = new ObjectInputStream(fileInputStream)) {
